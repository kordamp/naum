...
Anyone is welcome to open link:https://github.com/kordamp/naum/issues[issues] and/or pull-requests for bugfixes,
feature-requests and/or ideas. If unsure where to start we encourage you to open a
link:https://github.com/kordamp/naum/discussions[discussion] topic first.
...
1. `git clone https://github.com/kordamp/naum.git`
2. `cd naum`
3. `./gradlew build`
 ...
 * Create an link:https://github.com/kordamp/naum/issues[issue]  outlining the fix or feature.
...
Documentation changes should be posted to link:https://github.com/kordamp/naum/wiki[].
