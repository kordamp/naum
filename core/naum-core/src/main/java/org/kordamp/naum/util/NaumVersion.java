 ...
 * @since 0.1.0
 */
public class NaumVersion {
    private static final ResourceBundle BUNDLE = ResourceBundle.getBundle(NaumVersion.class.getName());
    private static final String JRELEASER_VERSION = BUNDLE.getString("naum_version");
    ...
    private static final String JARVIZ_VERSION_FORMATTED = "naum %s%n";
