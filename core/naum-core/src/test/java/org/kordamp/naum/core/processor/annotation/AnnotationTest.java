...
import org.kordamp.naum.core.model.ArrayValue;
import org.kordamp.naum.core.model.EnumValue;
import org.kordamp.naum.core.processor.AbstractProcessorTest;
import org.kordamp.naum.core.processor.annotation.WithAnnotationArrayValueAnnotation.AnotherAnnotation;
import org.kordamp.naum.core.processor.annotation.WithAnnotationArrayValueAnnotation.CustomAnnotationArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithAnnotationArrayValueAnnotation.DefaultAnnotationArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithAnnotationArrayValueAnnotation.EmptyAnnotationArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithAnnotationArrayValueAnnotation.SingleAnnotationArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithAnnotationValueAnnotation.CustomAnnotationValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithAnnotationValueAnnotation.DefaultAnnotationValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithAnnotationValueAnnotation.InnerAnnotation;
import org.kordamp.naum.core.processor.annotation.WithClassArrayValueAnnotation.CustomClassArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithClassArrayValueAnnotation.DefaultClassArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithClassArrayValueAnnotation.EmptyClassArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithClassArrayValueAnnotation.SingleClassArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithClassValueAnnotation.CustomArrayClassValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithClassValueAnnotation.CustomClassValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithClassValueAnnotation.DefaultClassValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithEnumArrayValueAnnotation.AnotherEnum;
import org.kordamp.naum.core.processor.annotation.WithEnumArrayValueAnnotation.CustomEnumArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithEnumArrayValueAnnotation.DefaultEnumArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithEnumArrayValueAnnotation.EmptyEnumArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithEnumArrayValueAnnotation.SingleEnumArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithEnumValueAnnotation.CustomEnumValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithEnumValueAnnotation.DefaultEnumValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithEnumValueAnnotation.SomeEnum;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveArrayValueAnnotation.ByteArrayAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveArrayValueAnnotation.CharArrayAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveArrayValueAnnotation.DoubleArrayAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveArrayValueAnnotation.FloatArrayAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveArrayValueAnnotation.IntArrayAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveArrayValueAnnotation.LongArrayAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveArrayValueAnnotation.ShortArrayAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveValueAnnotation.ByteValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveValueAnnotation.CharValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveValueAnnotation.DoubleValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveValueAnnotation.FloatValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveValueAnnotation.IntValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveValueAnnotation.LongValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithPrimitiveValueAnnotation.ShortValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithRetentionClassAnnotation.PlainClassAnnotation;
import org.kordamp.naum.core.processor.annotation.WithRetentionRuntimeAnnotation.PlainRuntimeAnnotation;
import org.kordamp.naum.core.processor.annotation.WithStringArrayValueAnnotation.CustomStringArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithStringArrayValueAnnotation.DefaultStringArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithStringArrayValueAnnotation.EmptyStringArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithStringArrayValueAnnotation.SingleStringArrayValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithStringValueAnnotation.CustomStringValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithStringValueAnnotation.EmptyDefaultStringValueAnnotation;
import org.kordamp.naum.core.processor.annotation.WithStringValueAnnotation.NonEmptyDefaultStringValueAnnotation;
...
import static org.kordamp.naum.core.NamedInfoMatcher.namedInfo;
...
import static org.kordamp.naum.core.model.AnnotationValue.newSimpleValue;
...
import static org.kordamp.naum.core.processor.annotation.WithEnumValueAnnotation.SomeEnum.NAUM;
